...
其实找了很多十代平台的EFI，包括其他品牌同款CPU i7-10875H的都不能启动，找到这里的EFI文件是唯一的一个能启动的！但定制的东西太多吧，又是9代平台的，OC的EFI在本机不能启动，试了一下clover的能启动Sonoma，这才开始了从clover的修改之旅！学了一些配置知识后，才跟进OC的</br>
</br>
</br>
工具、驱动来源：</br>
